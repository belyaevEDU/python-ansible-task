...
## Docker
Докерфайл прогонялся через Hadolint.

В Ansible я использую готовый image [belyaevedu/python-ansible-task](https://hub.docker.com/r/belyaevedu/python-ansible-task), собранный из материалов этого репозитория.
...
Остальные шаги прописаны напрямую в [плейбуке](/ansible/playbook.yml).